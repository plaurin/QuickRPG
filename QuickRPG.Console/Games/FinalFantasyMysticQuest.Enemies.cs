...
public partial class FinalFantasyMysticQuest
{
    public  IEnumerable<EnemyData> GetEnemiesData()
    {
        ...
        [
            ...
            NextEnemyData(0x00000, "Sparna",      0x30),
            ...
            NextEnemyData(0x00000, "Ninja",       0x62, 0x66, 0x69, 0x70),
            NextEnemyData(0x00000, "Shadow",      0xBE, 0xBF, 0xC0, 0xC2, 0xC3),
            NextEnemyData(0x00000, "Sphinx",      0x4B, 0x4E),
            NextEnemyData(0x00000, "Manticor",    0x9C, 0xA4, 0xA7, 0xB0),
            ...
            NextEnemyData(0x00000, "Fangpire",    0x6A, 0x73, 0x74, 0x76),
            NextEnemyData(0x00000, "Vampire",     0x94, 0x95),
            NextEnemyData(0x00000, "Mage",        0x3C, 0x3E, 0x45),
            NextEnemyData(0x00000, "Sorcerer",    0xA5, 0xA6, 0xA8, 0xAB, 0xAC, 0xAE),
            NextEnemyData(0x00000, "Land Turtle", 0x29, 0x2F),
            NextEnemyData(0x00000, "Adamant Turtle", 0x75, 0x78),
            ...
            NextEnemyData(0x00000, "Phanquid",    0x09, 0x40),
            NextEnemyData(0x00000, "Freezer Crab", 0x44, 0xC4),
            NextEnemyData(0x00000, "Iflyte",      0x11, 0x64, 0xC7, 0xC9),
            NextEnemyData(0x00000, "Stheno",      0x68, 0xC8),
            NextEnemyData(0x00000, "Chimera",     0x9D, 0xB6, 0xBA, 0xCB),
            NextEnemyData(0x00000, "Thanatos",    0xA2, 0xB7, 0xBD, 0xCC),
